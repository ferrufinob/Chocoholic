...
chocolate = Chocolate.create(brand: "Endangered Species", flavor: "Bold +Silky Dark Chocolate", country: "United States", note: "dairy free", cocoa: 72, category_id: cat1.id, user_id: user.id)
